...
```sh
python3 scripts/download_era5_conus_by_month.py --year 2020 --output-dir data/output/conus
```
...
`--max_wind_mps` if you want to adjust the playable-weather definition.
